...
OpenIMU hardware to fuse inertial-sensor data from accelerometers, rate-sensors, and magnetometers
...
description is not discussed here but is provided in the
