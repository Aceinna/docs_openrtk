...
.. table::  *Set Commands*
    ...
    +---------------------------+---------+--------------+-----------------------------------------------+
    | *Set Packet Rate Divider* |  65365  |  2           || Set rate dividers to increase/decrease       |
    ...
    +---------------------------+---------+--------------+-----------------------------------------------+
    || *Set Bank of PS*         |  65520  |  8           || Sets PS numbers for the 3 Get requests       |
    || *Numbers for Bank0*      |         |              || and the Reset Algorithm Set request          |
    +---------------------------+---------+--------------+-----------------------------------------------+
    || *Set Bank of PS*         |  65521  |  8           |  Sets PS numbers for the other Set requests   |
    || *Numbers for Bank1*      |         |              |                                               |
    +---------------------------+---------+--------------+-----------------------------------------------+



*Save Configuration* Set Request
...
*Set Packet Rate Divider* Set Request
...
*Set Data Packet Type(s)* Set Request
    ...
    .. table::  *Set Data Packet Type(s) Field*
        ...
        |        |  Address       |                                  |
        +--------+----------------+----------------------------------+
        | 1      || Selected Data || Value - Data Packet Type(s)     |
        |        || Packet Type(s)|| 1 - SSI2                        |
        |        |                || 2 - Angular Rate                |
        |        |                || 3 - SSI2 & Angular Rate         |
        |        |                || 4 - Acceleration                |
        |        |                || 5 - SSI2 & Acceleration         |
...
*Set Digital Filter Cutoff Frequencies* Set Request
...
*Set Bank of PS Numbers* Set Request
